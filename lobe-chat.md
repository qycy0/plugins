...
| :--- | :--- | :--- |
| **Provider ID** | `mirothinker` | Or any identifier you prefer. |
| **Sign in** | `API Key` | Select API Key authentication. |
| **API Key** | `EMPTY` | Use any string (e.g. `sk-xxxx`) if auth is disabled. |
